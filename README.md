...
- **Translation directions:** en-de, de-en, en-fr, fr-en, en-es, es-en (we opted for a english-centric setting). 
...
- **Test set:** For the en-es and es-en pairs the [newtest2013]() was used, while the [WMT14](https://huggingface.co/datasets/wmt14) datasets for all the other for all the translation directions.
